...
SECRET_KEY = 'django-insecure-ybx95x@+7h8h0iq%7s5vk1%*h9l3#%=lc8-ddp6jbtawv3)xsc'
...
# Define the TEMPLATES setting to specify the location of the template files.
TEMPLATES = [
    {
...
LOGIN_REDIRECT_URL = 'contact_details'
